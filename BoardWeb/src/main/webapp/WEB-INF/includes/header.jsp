    ...
    <body>
        <div class="d-flex" id="wrapper">
            ...
            <c:when test="${empty logid}">            
                <div class="sidebar-heading border-bottom bg-light">(Guest)님 환영합니다.</div>
            </c:when>
            <c:otherwise>
                ...
                <div class="list-group list-group-flush">
                    ...
                    <a class="list-group-item list-group-item-action list-group-item-light p-3" href="action.do">태그랑 놀자</a>
                     <c:choose>
            <c:when test="${empty logid}">            
